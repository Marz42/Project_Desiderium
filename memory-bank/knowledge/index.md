...
| [known-issues/brief-lazyload-missing-greenlet.md](known-issues/brief-lazyload-missing-greenlet.md) | `paradigma-known-issue` | Fresh Brief Row Triggers MissingGreenlet on First Read | MissingGreenlet<br>懒加载<br>简报 ... | - | related_to:/domains/admin-web.md<br>related_to:/contracts/data-model-contract.md |
...
| [known-issues/trend-consistency-baseline-drift.md](known-issues/trend-consistency-baseline-drift.md) | `paradigma-known-issue` | Trend Consistency Baseline Drift Between Production and Golden Paths | 趋势一致性<br>relevance<br>生命周期 ... | - | related_to:/domains/trend-engine.md<br>related_to:/plans/g3-g4-stabilization-plan.md |
| [manuals/desiderium-beta-trial.md](manuals/desiderium-beta-trial.md) | `paradigma-manual` | Desiderium Beta Trial Manual | 试运行手册<br>Beta 试运行<br>影子运行 ... | - | related_to:/plans/iteration-5-beta-observation.md<br>related_to:/manuals/desiderium-ops.md<br>related_to:/domains/trend-engine.md<br>related_to:/contracts/data-model-contract.md |
...
| [plans/beta-stabilization-plan.md](plans/beta-stabilization-plan.md) | `paradigma-plan` | Beta Stabilization Plan | Beta 稳定化<br>发布门<br>工程硬化 ... | - | depends_on:/project-brief.md<br>depends_on:/architecture.md<br>related_to:/contracts/scheduler-jobs-contract.md<br>related_to:/contracts/config-deployment-contract.md |
| [plans/g3-g4-stabilization-plan.md](plans/g3-g4-stabilization-plan.md) | `paradigma-plan` | G3/G4 Stabilization Plan | G3 趋势一致性<br>G4 发布表现<br>MyPy ... | - | depends_on:/project-brief.md<br>depends_on:/architecture.md<br>depends_on:/plans/beta-stabilization-plan.md<br>related_to:/decisions/adr-004-bounded-embedding-llm-clustering.md ... |
| [plans/iteration-5-beta-observation.md](plans/iteration-5-beta-observation.md) | `paradigma-plan` | Iteration 5 Beta Observation and Calibration | Beta 观察<br>G3 校准<br>G4 关联分析 ... | - | depends_on:/plans/g3-g4-stabilization-plan.md<br>related_to:/domains/trend-engine.md<br>related_to:/domains/admin-web.md |
